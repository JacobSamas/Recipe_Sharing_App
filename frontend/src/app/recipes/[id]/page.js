...
import { useParams } from 'next/navigation'; // Adjusting to use `useParams`

export default function RecipeDetailsPage() {
  const { id } = useParams(); // Using `useParams()` hook
  ...
  if (loading) return <p className="text-center py-8">Loading recipe...</p>;
